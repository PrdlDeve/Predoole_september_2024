...
package dpdp.batch_steward_withdraw_customers_sending_request_copy_0_9;
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_ICn_8FApEfC4ZuKDeZl3GA", "0.9");
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = Batch_Steward_Withdraw_Customers_Sending_Request_Copy.class.getClassLoader()
					.getResourceAsStream("dpdp/batch_steward_withdraw_customers_sending_request_copy_0_9/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
...
public void tRESTRequest_1_LoopProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		mdc("tRESTRequest_1_Loop", "IgqrmE_");
...
org.talend.components.datastewardship.tdatastewardshiptaskinput.TDataStewardshipTaskInputProperties props_tDataStewardshipTaskInput_1 =
        (org.talend.components.datastewardship.tdatastewardshiptaskinput.TDataStewardshipTaskInputProperties) def_tDataStewardshipTaskInput_1.createRuntimeProperties();
 		                    ...
 		                    context.Stewardship_UserName);
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:WMGVo5Hl7eSx/D+vS8pWS9+vFMvuhLjKAuMb/Lnmtsvg+Oi5xiM="));
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'Batch_Steward_Withdraw_Customers_Sending_Request_Copy' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2025-06-30T06:36:05.625763100Z");
        ...
        try {
            ...
            java.io.InputStream inContext = Batch_Steward_Withdraw_Customers_Sending_Request_Copy.class.getClassLoader().getResourceAsStream("dpdp/batch_steward_withdraw_customers_sending_request_copy_0_9/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     328164 characters generated by Talend Real-time Big Data Platform 
 *     on the 30 June 2025 at 12:06:05 pm IST
 ************************************************************************************************/