...
package dpdp.batch_stewardship_withdraw_customers_accepting_delete_request_0_4;
...
/**
 * Job: Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request Purpose: <br>
 * Description:  <br>
 * @author Patil, Chirag
...
public class Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request implements TalendJob {
	static {System.setProperty("TalendJob.log", "Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request.class);
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_IIjBwFApEfC4ZuKDeZl3GA", "0.4");
...
private class TalendException extends Exception {
	...
	public void printStackTrace() {
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
		...
		if(enableLogStash) {
			...
			public void tRESTRequest_2_Loop_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
				
							tRESTRequest_2_In_error(exception, errorComponent, globalMap);
						
						}
					
			public void tRESTRequest_2_In_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void tRESTRequest_2_Loop_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public String getRestEndpoint() {
	return "http://192.168.1.163:8060/services/GDPR/customer";
}
...
public static class RestServiceProviderImpl4TalendJob {
	...
	private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request job) {
	...
	public jakarta.ws.rs.core.Response deleteCustomer(
		...
		, 
				@jakarta.ws.rs.PathParam("tableId") String tableId
                ...
                if(requiredParameterWithNullValueList.size() > 0){
                    return handleWrongRequest(messageContext, 400, "400 Bad Request \n" + requiredParameterWithNullValueList.toString() + " in tRESTRequest_2:deleteCustomer " + (requiredParameterWithNullValueList.size() == 1 ? "is required!" : "are required!"));         
                }
		...
		request_tRESTRequest_2.put("PATTERN", "/{id}/{tableId}");
...
class Thread4RestServiceProviderEndpoint extends Thread {
	...
	public Thread4RestServiceProviderEndpoint(Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request job, String endpointUrl) {
		this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request.class.getClassLoader()
					.getResourceAsStream("dpdp/batch_stewardship_withdraw_customers_accepting_delete_request_0_4/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DPDP_Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request.length) {
				if(length < 1024 && commonByteArray_DPDP_Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request.length == 0) {
   					commonByteArray_DPDP_Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request = new byte[1024];
				} else {
   					commonByteArray_DPDP_Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DPDP_Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request, 0, length);
			strReturn = new String(commonByteArray_DPDP_Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_DPDP_Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request, 0, length);
			strReturn = new String(commonByteArray_DPDP_Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request, 0, length, utf8Charset);
		}
		return strReturn;
	}
			...
			cLabel="GetAuthToken";
					...
					if(enableLogStash) {
						if(runStat.updateLog(iterateId,1,1
							...
							,"row2","tFixedFlowInput_2","DefineInput","tFixedFlowInput","tRESTClient_4","GetAuthToken","tRESTClient"
...
try {
    ...
    if (clientConfig_tRESTClient_4.getEndpoint() != null) {
		org.apache.cxf.service.model.EndpointInfo endpointInfo_tRESTClient_4 = clientConfig_tRESTClient_4.getEndpoint().getEndpointInfo();
		...
		if (webClientResponseStatus_tRESTClient_4 >= 300) {
			...
			row1.string = "";
				...
				if(responseDoc_tRESTClient_4 != null && responseDoc_tRESTClient_4.hasEntity()){
					responseObj_tRESTClient_4 = responseDoc_tRESTClient_4.readEntity(responseClass_tRESTClient_4);
				
				if(responseObj_tRESTClient_4 != null){
					if (responseClass_tRESTClient_4 == String.class && responseObj_tRESTClient_4 instanceof String) {
			...
			if (webClient_tRESTClient_4.getResponse() != null && webClient_tRESTClient_4.getResponse().getCookies() != null ) { 
			...
			cLabel="ParseAuthResponse_TXMLMAP_OUT";
					...
					if(enableLogStash) {
						if(runStat.updateLog(iterateId,1,1
							...
							,"row1","tRESTClient_4","GetAuthToken","tRESTClient","tXMLMap_4_TXMLMAP_OUT","ParseAuthResponse_TXMLMAP_OUT","tXMLMapOut"
...
copyOfsetToken_tmp.value = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("row1.body:/root/result/token");allOutsForAggregate_tXMLMap_4.add(copyOfsetToken_tmp);

log.debug("tXMLMap_4 - Outputting the record " + count_copyOfsetToken_tXMLMap_4_TXMLMAP_OUT + " of the output table 'copyOfsetToken'.");
...
// [tRESTCliend_end]
				if(enableLogStash) {
				 		...
				 		if(runStat.log(resourceMap,iterateId,"row2",2,0,
				 			"tFixedFlowInput_2","DefineInput","tFixedFlowInput","tRESTClient_4","GetAuthToken","tRESTClient","output")) {
							talendJobLogProcess(globalMap);
						}
 ...
 */
	...
	s(currentComponent="tXMLMap_4_TXMLMAP_OUT");
		...
		log.debug("tXMLMap_4 - Written records count in the table 'copyOfsetToken': " + count_copyOfsetToken_tXMLMap_4_TXMLMAP_OUT + ".");
				...
				if(enableLogStash) {
				 		...
				 		if(runStat.log(resourceMap,iterateId,"row1",2,0,
				 			"tRESTClient_4","GetAuthToken","tRESTClient","tXMLMap_4_TXMLMAP_OUT","ParseAuthResponse_TXMLMAP_OUT","tXMLMapOut","output")) {
							talendJobLogProcess(globalMap);
						}
 ...
 */
	...
	s(currentComponent="tLogRow_4");
		...
		int tos_count_tLogRow_4 = 0;
			...
			if(enableLogStash) {
				talendJobLog.addCM("tLogRow_4", "tLogRow_1", "tLogRow");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
 ...
 */
	...
	s(currentComponent="tContextLoad_4");
			...
			cLabel="LoadContextToken";
					...
					if(enableLogStash) {
						runStat.log(resourceMap,iterateId,0,0,"copyOfsetToken");
					}
 ...
 */
	...
	copyOfsetToken = null;
	if(row_out_tXMLMap_4_TXMLMAP_IN!=null && row_out_tXMLMap_4_TXMLMAP_IN instanceof copyOfsetTokenStruct) {
	...
	s(currentComponent="tContextLoad_4");
			...
			cLabel="LoadContextToken";
					...
					if(enableLogStash) {
						if(runStat.updateLog(iterateId,1,1
							...
							,"copyOfsetToken","tXMLMap_4_TXMLMAP_IN","ParseAuthResponse_TXMLMAP_IN","tXMLMapIn","tContextLoad_4","LoadContextToken","tContextLoad"
    			...
    			if(log.isTraceEnabled()){
    				log.trace("copyOfsetToken - " + (copyOfsetToken==null? "": copyOfsetToken.toLogString()));
    			}
        ...
        String tmp_key_tContextLoad_4 = null;
                    ...
                    value_tContextLoad_4 =
                        copyOfsetToken.value;
                        }
				
				String currentValue_tContextLoad_4 = value_tContextLoad_4;
										
						if ((key_tContextLoad_4 != null) && ("Stewardship_Password".equals(key_tContextLoad_4)) && (currentValue_tContextLoad_4 != null)) 
...
globalMap.put("tContextLoad_4_ERROR_MESSAGE",e.getMessage());
            log.error("tContextLoad_4 - Setting a value for the key \"" + key_tContextLoad_4 + "\" has failed. Error message: " + e.getMessage());
	...
	s(currentComponent="tLogRow_4");
					...
					if(enableLogStash) {
						if(runStat.updateLog(iterateId,1,1
							...
							,"row5","tContextLoad_4","LoadContextToken","tContextLoad","tLogRow_4","tLogRow_1","tLogRow"
 ...
 */
	...
	resumeUtil.addLog("NODE", "NODE:tContextLoad_4", "", Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt_tContextLoad_4));    
    	log.info("tContextLoad_4 - Loaded contexts count: " + nb_line_tContextLoad_4 + ".");
    
				if(enableLogStash) {
				
				 		if(runStat.log(resourceMap,iterateId,"copyOfsetToken",2,0,
				 			"tXMLMap_4_TXMLMAP_IN","ParseAuthResponse_TXMLMAP_IN","tXMLMapIn","tContextLoad_4","LoadContextToken","tContextLoad","output")) {
							talendJobLogProcess(globalMap);
						}
...
///////////////////////    			
				...
				if(enableLogStash) {
				 		...
				 		if(runStat.log(resourceMap,iterateId,"row5",2,0,
				 			"tContextLoad_4","LoadContextToken","tContextLoad","tLogRow_4","tLogRow_1","tLogRow","output")) {
							talendJobLogProcess(globalMap);
						}
...
setTableNameStruct row3 = setTableName;
	...
	s(currentComponent="tXMLMap_1_TXMLMAP_OUT");
			...
			cLabel="ParseTableResponse_TXMLMAP_OUT";
					...
					if(enableLogStash) {
						runStat.log(resourceMap,iterateId,0,0,"sendTable");
					}
...
try {
	...
	try {
		// start send request
            ...
            if (status_tRESTClient_3 != 304 && status_tRESTClient_3 >= 300 && responseClass_tRESTClient_3 != jakarta.ws.rs.core.Response.class) {
                throw org.apache.cxf.jaxrs.utils.ExceptionUtils.toWebApplicationException((jakarta.ws.rs.core.Response)responseObjBase_tRESTClient_3);
            }
		...
		if (webClientResponseStatus_tRESTClient_3 >= 300) {
			...
			if (webClient_tRESTClient_3.getResponse() != null && webClient_tRESTClient_3.getResponse().getCookies() != null ) { 
			...
			cLabel="ParseTableResponse_TXMLMAP_OUT";
					...
					if(enableLogStash) {
						if(runStat.updateLog(iterateId,1,1
							...
							,"sendTable","tRESTClient_3","GetTableName","tRESTClient","tXMLMap_1_TXMLMAP_OUT","ParseTableResponse_TXMLMAP_OUT","tXMLMapOut"
...
"Parent".equals(treeNodeAPI_tXMLMap_1_TXMLMAP_OUT.get_String("sendTable.body:/root/result/attributes/attributeType/name"))
...
databaseId_tmp.value = treeNodeAPI_tXMLMap_1_TXMLMAP_OUT.get_String("sendTable.body:/root/result/attributes/value") ;allOutsForAggregate_tXMLMap_1.add(databaseId_tmp);

log.debug("tXMLMap_1 - Outputting the record " + count_databaseId_tXMLMap_1_TXMLMAP_OUT + " of the output table 'databaseId'.");
...
"Name".equals(treeNodeAPI_tXMLMap_1_TXMLMAP_OUT.get_String("sendTable.body:/root/result/attributes/attributeType/name"))
...
setTableName_tmp.value =   treeNodeAPI_tXMLMap_1_TXMLMAP_OUT.get_String("sendTable.body:/root/result/attributes/value");allOutsForAggregate_tXMLMap_1.add(setTableName_tmp);

log.debug("tXMLMap_1 - Outputting the record " + count_setTableName_tXMLMap_1_TXMLMAP_OUT + " of the output table 'setTableName'.");
 ...
 */
	...
	s(currentComponent="tXMLMap_1_TXMLMAP_OUT");
		...
		log.debug("tXMLMap_1 - Written records count in the table 'databaseId': " + count_databaseId_tXMLMap_1_TXMLMAP_OUT + ".");		log.debug("tXMLMap_1 - Written records count in the table 'setTableName': " + count_setTableName_tXMLMap_1_TXMLMAP_OUT + ".");



				if(enableLogStash) {
				
				 		if(runStat.log(resourceMap,iterateId,"sendTable",2,0,
				 			"tRESTClient_3","GetTableName","tRESTClient","tXMLMap_1_TXMLMAP_OUT","ParseTableResponse_TXMLMAP_OUT","tXMLMapOut","output")) {
							talendJobLogProcess(globalMap);
						}
 ...
 */
	...
	s(currentComponent="tContextLoad_2");
			...
			cLabel="LoadContextDatabaseName";
					...
					if(enableLogStash) {
						runStat.log(resourceMap,iterateId,0,0,"databaseId");
					}
 ...
 */
	...
	s(currentComponent="tContextLoad_1");
			...
			cLabel="LoadContextTableName";
					...
					if(enableLogStash) {
						runStat.log(resourceMap,iterateId,0,0,"setTableName");
					}
 ...
 */
	...
	databaseId = null;
	if(row_out_tXMLMap_1_TXMLMAP_IN!=null && row_out_tXMLMap_1_TXMLMAP_IN instanceof databaseIdStruct) {
		databaseId = (databaseIdStruct)row_out_tXMLMap_1_TXMLMAP_IN;		
	}
	setTableName = null;
	if(row_out_tXMLMap_1_TXMLMAP_IN!=null && row_out_tXMLMap_1_TXMLMAP_IN instanceof setTableNameStruct) {
	...
	s(currentComponent="tContextLoad_2");
			...
			cLabel="LoadContextDatabaseName";
					...
					if(enableLogStash) {
						if(runStat.updateLog(iterateId,1,1
							...
							,"databaseId","tXMLMap_1_TXMLMAP_IN","ParseTableResponse_TXMLMAP_IN","tXMLMapIn","tContextLoad_2","LoadContextDatabaseName","tContextLoad"
        ...
        String tmp_key_tContextLoad_2 = null;
				...
				String currentValue_tContextLoad_2 = value_tContextLoad_2;
						...
						if ((key_tContextLoad_2 != null) && ("Stewardship_Password".equals(key_tContextLoad_2)) && (currentValue_tContextLoad_2 != null)) 
	...
	s(currentComponent="tLogRow_3");
					...
					if(enableLogStash) {
						if(runStat.updateLog(iterateId,1,1
							...
							,"row4","tContextLoad_2","LoadContextDatabaseName","tContextLoad","tLogRow_3","tLogRow_1","tLogRow"
			...
			cLabel="LoadContextTableName";
					...
					if(enableLogStash) {
						if(runStat.updateLog(iterateId,1,1
							...
							,"setTableName","tXMLMap_1_TXMLMAP_IN","ParseTableResponse_TXMLMAP_IN","tXMLMapIn","tContextLoad_1","LoadContextTableName","tContextLoad"
	...
	s(currentComponent="tLogRow_2");
					...
					if(enableLogStash) {
						if(runStat.updateLog(iterateId,1,1
							...
							,"row3","tContextLoad_1","LoadContextTableName","tContextLoad","tLogRow_2","tLogRow_1","tLogRow"
 ...
 */
	...
	resumeUtil.addLog("NODE", "NODE:tContextLoad_2", "", Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt_tContextLoad_2));    
    	log.info("tContextLoad_2 - Loaded contexts count: " + nb_line_tContextLoad_2 + ".");
    
				if(enableLogStash) {
				
				 		if(runStat.log(resourceMap,iterateId,"databaseId",2,0,
				 			"tXMLMap_1_TXMLMAP_IN","ParseTableResponse_TXMLMAP_IN","tXMLMapIn","tContextLoad_2","LoadContextDatabaseName","tContextLoad","output")) {
							talendJobLogProcess(globalMap);
						}
...
///////////////////////    			
				...
				if(enableLogStash) {
				 		...
				 		if(runStat.log(resourceMap,iterateId,"row4",2,0,
				 			"tContextLoad_2","LoadContextDatabaseName","tContextLoad","tLogRow_3","tLogRow_1","tLogRow","output")) {
							talendJobLogProcess(globalMap);
						}
	...
	resumeUtil.addLog("NODE", "NODE:tContextLoad_1", "", Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt_tContextLoad_1));    
    	log.info("tContextLoad_1 - Loaded contexts count: " + nb_line_tContextLoad_1 + ".");
				...
				if(enableLogStash) {
				 		...
				 		if(runStat.log(resourceMap,iterateId,"setTableName",2,0,
				 			"tXMLMap_1_TXMLMAP_IN","ParseTableResponse_TXMLMAP_IN","tXMLMapIn","tContextLoad_1","LoadContextTableName","tContextLoad","output")) {
							talendJobLogProcess(globalMap);
						}
...
///////////////////////    			
				...
				if(enableLogStash) {
				 		...
				 		if(runStat.log(resourceMap,iterateId,"row3",2,0,
				 			"tContextLoad_1","LoadContextTableName","tContextLoad","tLogRow_2","tLogRow_1","tLogRow","output")) {
							talendJobLogProcess(globalMap);
						}
...
public static class copyOfsendDeleteMessage1Struct implements routines.system.IPersistableRow<copyOfsendDeleteMessage1Struct> {
    final static byte[] commonByteArrayLock_DPDP_Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request = new byte[0];
    static byte[] commonByteArray_DPDP_Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request = new byte[0];
 ...
 */
	...
	s(currentComponent="tLogRow_5");
			...
			cLabel="LogDeleteAction";
					...
					if(enableLogStash) {
						runStat.log(resourceMap,iterateId,0,0,"copyOfsendDeleteMessage1");
					}
...
if (needRoot) {
	needRoot=false;
		...
		valueMap.put("root_0",row6.newColumn + " has beed deleted from table: " + context.tableName + " and database: " + context.databaseName );
 ...
 */
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBRow_1{
                    ...
                    log4jParamters_tDBRow_1.append("Parameters:");
                        ...
                        log4jParamters_tDBRow_1.append(" | ");
                            log4jParamters_tDBRow_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:saTJnRpWHX7GvrK7k88UYgxWa0JUw4CJpr6ntFBWdLS6+5LB7ko5CtU=").substring(0, 4) + "...");     
                        log4jParamters_tDBRow_1.append(" | ");
                            log4jParamters_tDBRow_1.append("IDENTITY_INSERT" + " = " + "false");
                        log4jParamters_tDBRow_1.append(" | ");
                            log4jParamters_tDBRow_1.append("QUERYSTORE" + " = " + "");
                        log4jParamters_tDBRow_1.append(" | ");
                            log4jParamters_tDBRow_1.append("QUERY" + " = " + "/*\"DELETE FROM \" + context.tableName + \" WHERE customer_id = '\" + context.customerId + \"'\"  */  \"DELETE FROM \" + context.databaseName + \".\" + context.tableName + \" WHERE customer_id = '\" + context.customerId + \"'\"");
                        log4jParamters_tDBRow_1.append(" | ");
	...
	final String decryptedPassword_tDBRow_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:udqnThqcjP/EbRDzYtIlTwRO9iUovOIc0WCGITjt6LXd45k9BDOUm/0=");
        		   	
        	        String dbPwd_tDBRow_1 = decryptedPassword_tDBRow_1;
	        
					
	    		log.debug("tDBRow_1 - Connection attempt to '" + url_tDBRow_1.replaceAll("(?<=trustStorePassword=)[^;]*", "********") + "' with the username '" + dbUser_tDBRow_1 + "'.");
			
			conn_tDBRow_1 = java.sql.DriverManager.getConnection(url_tDBRow_1,dbUser_tDBRow_1,dbPwd_tDBRow_1);
		
	    		log.debug("tDBRow_1 - Connection to '" + url_tDBRow_1.replaceAll("(?<=trustStorePassword=)[^;]*", "********") + "' has succeeded.");
...
query_tDBRow_1 = /*"DELETE FROM " + context.tableName + " WHERE customer_id = '" + context.customerId + "'"
*/
"DELETE FROM " + context.databaseName + "." + context.tableName + " WHERE customer_id = '" + context.customerId + "'";
...
try {
			...
			do {
			    ...
			    if (isResultSet_tDBRow_1) rsMulti_tDBRow_1 = commonSt_tDBRow_1.getResultSet();
...
gen_Doc_copyOfsendDeleteMessage1_tXMLMap_5.generateElements(rejectedDocInnerJoin_tXMLMap_5,row6,Var);

if(copyOfsendDeleteMessage1_tmp.body == null){
copyOfsendDeleteMessage1_tmp.body = new routines.system.Document();
copyOfsendDeleteMessage1_tmp.body.setDocument(gen_Doc_copyOfsendDeleteMessage1_tXMLMap_5.getDocument());
}

copyOfsendDeleteMessage1 = copyOfsendDeleteMessage1_tmp;
copyOfsendDeleteMessage1_save = copyOfsendDeleteMessage1_tmp;
log.debug("tXMLMap_5 - Outputting the record " + count_copyOfsendDeleteMessage1_tXMLMap_5 + " of the output table 'copyOfsendDeleteMessage1'.");
			...
			cLabel="LogDeleteAction";
					...
					if(enableLogStash) {
						if(runStat.updateLog(iterateId,1,1
							...
							,"copyOfsendDeleteMessage1","tXMLMap_5","SetDeleteMesssage","tXMLMap","tLogRow_5","LogDeleteAction","tLogRow"
    			...
    			if(log.isTraceEnabled()){
    				log.trace("copyOfsendDeleteMessage1 - " + (copyOfsendDeleteMessage1==null? "": copyOfsendDeleteMessage1.toLogString()));
    			}
...
///////////////////////		
	    		...
	    		if(copyOfsendDeleteMessage1.body != null) { //              
                 row_tLogRow_5[0]=    						    
				                String.valueOf(copyOfsendDeleteMessage1.body)			
					          ;	
			...
			cLabel="DeleteResponse";
					...
					if(enableLogStash) {
						if(runStat.updateLog(iterateId,1,1
							...
							,"row7","tLogRow_5","LogDeleteAction","tLogRow","tRESTResponse_3","DeleteResponse","tRESTResponse"
	...
	if (null == outputStream_tRESTResponse_3 && responseAlreadySent_tRESTResponse_3) {
		...
		if (null == outputStream_tRESTResponse_3) {
			...
			if (!responseAlreadySent_tRESTResponse_3) {
				...
				responseMediaType_tRESTResponse_3 = (jakarta.ws.rs.core.MediaType) globalMap.get("restResponseMediaType");
			}
			...
			if (null != restProviderResponse_tRESTResponse_3) {
				...
				jakarta.ws.rs.ext.Providers messageBodyProviders_tRESTResponse_3 = messageContext_tRESTResponse_3.getProviders();
				jakarta.ws.rs.ext.MessageBodyWriter messageBodyWriter_tRESTResponse_3 = messageBodyProviders_tRESTResponse_3.getMessageBodyWriter(
 ...
 */
	...
	s(currentComponent="tXMLMap_5");
		...
		log.debug("tXMLMap_5 - Written records count in the table 'copyOfsendDeleteMessage1': " + count_copyOfsendDeleteMessage1_tXMLMap_5 + ".");
				if(enableLogStash) {
				
				 		if(runStat.log(resourceMap,iterateId,"row6",2,0,
				 			"tDBRow_1","tDBRow_1","tMSSqlRow","tXMLMap_5","SetDeleteMesssage","tXMLMap","output")) {
							talendJobLogProcess(globalMap);
						}
...
///////////////////////    			
				...
				if(enableLogStash) {
				 		...
				 		if(runStat.log(resourceMap,iterateId,"copyOfsendDeleteMessage1",2,0,
				 			"tXMLMap_5","SetDeleteMesssage","tXMLMap","tLogRow_5","LogDeleteAction","tLogRow","output")) {
							talendJobLogProcess(globalMap);
						}
	...
	s(currentComponent="tRESTResponse_3");
			...
			cLabel="DeleteResponse";
				...
				if(enableLogStash) {
				 		...
				 		if(runStat.log(resourceMap,iterateId,"row7",2,0,
				 			"tLogRow_5","LogDeleteAction","tLogRow","tRESTResponse_3","DeleteResponse","tRESTResponse","output")) {
							talendJobLogProcess(globalMap);
						}
...
public void tRESTRequest_2_LoopProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		mdc("tRESTRequest_2_Loop", "TvCplk_");
		...
		int tos_count_tRESTRequest_2_Loop = 0;
			...
			if(enableLogStash) {
				...
				s(currentComponent);
						...
						if(enableLogStash){
							runStat.log(iterateId,0,0,"deleteCustomer");
						}
	...
	try {
		...
		java.util.Map<String, Object> requestMessage_tRESTRequest_2 =
		...
		if (null == requestMessage_tRESTRequest_2) {
			...
			if (restTalendJobAlreadyStarted) {
				...
				if (!runInTalendEsbRuntimeContainer && null == thread4RestServiceProviderEndpoint) {
					...
					thread4RestServiceProviderEndpoint = new Thread4RestServiceProviderEndpoint(this, endpointUrl_tRESTRequest_2);
        ...
        requestMessage_tRESTRequest_2.put("CURRENT_MESSAGE", org.apache.cxf.jaxrs.utils.JAXRSUtils.getCurrentMessage());

        Object ctx_tRESTRequest_2 = requestMessage_tRESTRequest_2.get("MESSAGE_CONTEXT");
        if (ctx_tRESTRequest_2 != null && ctx_tRESTRequest_2 instanceof org.apache.cxf.jaxrs.impl.tl.ThreadLocalMessageContext) {
            requestMessage_tRESTRequest_2.put("MESSAGE_CONTEXT", ((org.apache.cxf.jaxrs.impl.tl.ThreadLocalMessageContext)ctx_tRESTRequest_2).get());
        }
 ...
 */
	...
	s(currentComponent="tRESTRequest_2_In");
		...
		if (requestMessage_tRESTRequest_2.containsKey("ERROR")) { // wrong request received
			...
			java.util.Map<String, Object> params_tRESTRequest_2 =
				(java.util.Map<String, Object>) requestMessage_tRESTRequest_2.get("PARAMS");
		...
		globalMap.put("tRESTRequest_2_URI_ABSOLUTE", (String) requestMessage_tRESTRequest_2.get("URI_ABSOLUTE"));
		globalMap.put("tRESTRequest_2_URI_REQUEST", (String) requestMessage_tRESTRequest_2.get("URI_REQUEST"));
		globalMap.put("tRESTRequest_2_HTTP_METHOD", (String) requestMessage_tRESTRequest_2.get("VERB"));

		globalMap.put("tRESTRequest_2_ATTACHMENT_HEADERS", requestMessage_tRESTRequest_2.get("ATTACHMENT_HEADERS"));
		globalMap.put("tRESTRequest_2_ATTACHMENT_FILENAMES", requestMessage_tRESTRequest_2.get("ATTACHMENT_FILENAMES"));

		globalMap.put("tRESTRequest_2_PRINCIPAL_NAME", (String) requestMessage_tRESTRequest_2.get("PRINCIPAL_NAME"));
		globalMap.put("tRESTRequest_2_CORRELATION_ID", (String) requestMessage_tRESTRequest_2.get("CorrelationID"));
			...
			cLabel="FlowToIterate";
					...
					if(enableLogStash) {
						if(runStat.updateLog(iterateId,1,1
							...
							,"deleteCustomer","tRESTRequest_2_In","DeleteCustomerFromTable_In","tRESTRequestIn","tFlowToIterate_1","FlowToIterate","tFlowToIterate"
                ...
                if(log.isTraceEnabled())
            log.trace("tFlowToIterate_1 - "  + ("Set global var, key=deleteCustomer.id, value=")  + (deleteCustomer.id)  + (".") );            
            globalMap.put("deleteCustomer.id", deleteCustomer.id);
    	
                if(log.isTraceEnabled())
            log.trace("tFlowToIterate_1 - "  + ("Set global var, key=deleteCustomer.tableId, value=")  + (deleteCustomer.tableId)  + (".") );            
...
globalMap.put("tFlowToIterate_1_NB_LINE",nb_line_tFlowToIterate_1);
				if(enableLogStash) {
				 		...
				 		if(runStat.log(resourceMap,iterateId,"deleteCustomer",2,0,
				 			"tRESTRequest_2_In","DeleteCustomerFromTable_In","tRESTRequestIn","tFlowToIterate_1","FlowToIterate","tFlowToIterate","output")) {
							talendJobLogProcess(globalMap);
						}
 ...
 */
	...
	s(currentComponent="tRESTRequest_2_Loop");
        ...
        if (e_tRESTRequest_2 instanceof Exception) {
			new TalendException((Exception) e_tRESTRequest_2, currentComponent, globalMap).printStackTrace();
        } else {
			new TalendException(new RuntimeException (e_tRESTRequest_2), currentComponent, globalMap).printStackTrace();
       	}
	...
	globalMap.put("tRESTRequest_2_NB_LINE", nb_line_tRESTRequest_2);
				...
				if(enableLogStash){
					runStat.log(iterateId,2,0,"deleteCustomer");
				}
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2025-06-26T10:04:18.571240400Z");
        ...
        try {
            ...
            java.io.InputStream inContext = Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request.class.getClassLoader().getResourceAsStream("dpdp/batch_stewardship_withdraw_customers_accepting_delete_request_0_4/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
try {
errorCode = null;tRESTRequest_2_LoopProcess(globalMap);
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request");
        }
		if(enableLogStash) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     366688 characters generated by Talend Real-time Big Data Platform 
 *     on the 26 June 2025 at 3:34:18 pm IST
 ************************************************************************************************/