...
package dpdp.portal_get_request_0_4;
...
/**
 * Job: Portal_Get_Request Purpose: <br>
 * Description:  <br>
 * @author Patil, Chirag
 * @version 8.0.1.20250521_1150-patch
 * @status 
 */
public class Portal_Get_Request implements TalendJob {
	static {System.setProperty("TalendJob.log", "Portal_Get_Request.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Portal_Get_Request.class);
...
public String getStewardship_UserName(){
	...
	private final String jobName = "Portal_Get_Request";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_P85dkFcpEfC6gZ-bcMizWA", "0.4");
...
private class TalendException extends Exception {
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TalendException)) {
			Portal_Get_Request.this.exception = e;
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Portal_Get_Request.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class RestServiceProviderImpl4TalendJob {
	...
	private final Portal_Get_Request job;


	public RestServiceProviderImpl4TalendJob() {
		this.job = new Portal_Get_Request();
	}

	public RestServiceProviderImpl4TalendJob(Portal_Get_Request job) {
		this.job = job;
	}

	private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, Portal_Get_Request job) {
	...
	private jakarta.ws.rs.core.Response processRequest(java.util.Map<String, Object> request) {
		...
		try {
            ...
            String taskExecutionId = Portal_Get_Request.taskExecutionId;
            String jobExecutionId = Portal_Get_Request.jobExecutionId;
...
class Thread4RestServiceProviderEndpoint extends Thread {
	...
	public Thread4RestServiceProviderEndpoint(Portal_Get_Request job, String endpointUrl) {
		this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = Portal_Get_Request.class.getClassLoader()
					.getResourceAsStream("dpdp/portal_get_request_0_4/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
				inContext = Portal_Get_Request.class.getClassLoader()
...
public static class withdrawStruct implements routines.system.IPersistableRow<withdrawStruct> {
    final static byte[] commonByteArrayLock_DPDP_Portal_Get_Request = new byte[0];
    static byte[] commonByteArray_DPDP_Portal_Get_Request = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DPDP_Portal_Get_Request.length) {
				if(length < 1024 && commonByteArray_DPDP_Portal_Get_Request.length == 0) {
   					commonByteArray_DPDP_Portal_Get_Request = new byte[1024];
				} else {
   					commonByteArray_DPDP_Portal_Get_Request = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DPDP_Portal_Get_Request, 0, length);
			strReturn = new String(commonByteArray_DPDP_Portal_Get_Request, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_DPDP_Portal_Get_Request, 0, length);
			strReturn = new String(commonByteArray_DPDP_Portal_Get_Request, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DPDP_Portal_Get_Request) {
...
public void tRESTRequest_1_LoopProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		mdc("tRESTRequest_1_Loop", "bo6EmV_");
 ...
 */
    ...
    public static void main(String[] args){
        final Portal_Get_Request Portal_Get_RequestClass = new Portal_Get_Request();

        int exitCode = Portal_Get_RequestClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Portal_Get_Request' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'Portal_Get_Request' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_P85dkFcpEfC6gZ-bcMizWA");
                org.slf4j.MDC.put("_compiledAtTimestamp","2025-07-02T11:16:01.723149800Z");
        ...
        try {
            ...
            java.io.InputStream inContext = Portal_Get_Request.class.getClassLoader().getResourceAsStream("dpdp/portal_get_request_0_4/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Portal_Get_Request.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'Portal_Get_Request' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Portal_Get_Request");
        }
		if(enableLogStash) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'Portal_Get_Request' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     133022 characters generated by Talend Real-time Big Data Platform 
 *     on the 2 July 2025 at 4:46:01 pm IST
 ************************************************************************************************/