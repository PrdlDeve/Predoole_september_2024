...
package dpdp.batch_stewardshipwithdraw_copy_0_3;
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_IRW_gFApEfC4ZuKDeZl3GA", "0.3");
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = Batch_StewardshipWithdraw_Copy.class.getClassLoader()
					.getResourceAsStream("dpdp/batch_stewardshipwithdraw_copy_0_3/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
...
public void tRESTRequest_1_LoopProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		mdc("tRESTRequest_1_Loop", "Urcq5c_");
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'Batch_StewardshipWithdraw_Copy' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2025-07-02T09:07:10.452388600Z");
        ...
        try {
            ...
            java.io.InputStream inContext = Batch_StewardshipWithdraw_Copy.class.getClassLoader().getResourceAsStream("dpdp/batch_stewardshipwithdraw_copy_0_3/contexts/" + contextStr + ".properties");
            if (inContext == null) {
 ...
 *     on the 2 July 2025 at 2:37:10 pm IST
 ************************************************************************************************/