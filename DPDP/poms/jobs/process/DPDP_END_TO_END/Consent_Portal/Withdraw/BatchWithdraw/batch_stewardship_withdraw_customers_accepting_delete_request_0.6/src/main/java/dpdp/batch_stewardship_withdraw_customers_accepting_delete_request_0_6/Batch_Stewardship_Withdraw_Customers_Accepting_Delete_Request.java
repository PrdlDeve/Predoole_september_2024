...
package dpdp.batch_stewardship_withdraw_customers_accepting_delete_request_0_6;
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_IIjBwFApEfC4ZuKDeZl3GA", "0.6");
...
public String getRestEndpoint() {
	return "http://192.168.1.163:8040/GDPR/customer";
}
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request.class.getClassLoader()
					.getResourceAsStream("dpdp/batch_stewardship_withdraw_customers_accepting_delete_request_0_6/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
 ...
 */
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBRow_1{
                    ...
                    log4jParamters_tDBRow_1.append("Parameters:");
                        ...
                        log4jParamters_tDBRow_1.append(" | ");
                            log4jParamters_tDBRow_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:NdgHRNaS4ZufZ7lyqtWEOBAU+WfLO3M3jy7W/1xtn4c5dK41/5MqsTg=").substring(0, 4) + "...");     
                        log4jParamters_tDBRow_1.append(" | ");
	...
	final String decryptedPassword_tDBRow_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:nRR2y6BuE71pUVlG80QYtGwlvtPoXvoqGuk3PPA2e6Dowk4naX2kIEk=");
...
public void tRESTRequest_2_LoopProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		mdc("tRESTRequest_2_Loop", "hB2euo_");
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2025-06-26T11:30:23.594495Z");
        ...
        try {
            ...
            java.io.InputStream inContext = Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request.class.getClassLoader().getResourceAsStream("dpdp/batch_stewardship_withdraw_customers_accepting_delete_request_0_6/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     366676 characters generated by Talend Real-time Big Data Platform 
 *     on the 26 June 2025 at 5:00:23 pm IST
 ************************************************************************************************/