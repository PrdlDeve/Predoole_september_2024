...
package dpdp.batch_steward_withdraw_customers_sending_request_copy_0_4;
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_ICn_8FApEfC4ZuKDeZl3GA", "0.4");
...
public String getRestEndpoint() {
	return "http://192.168.1.163:8050/services/steward";
}
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = Batch_Steward_Withdraw_Customers_Sending_Request_Copy.class.getClassLoader()
					.getResourceAsStream("dpdp/batch_steward_withdraw_customers_sending_request_copy_0_4/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
...
try {
	...
	String url = null;
		...
		url = "http://192.168.1.163:8060/services/GDPR/customer/";
		// {baseUri}tRESTClient
...
public void tRESTRequest_1_LoopProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		mdc("tRESTRequest_1_Loop", "xgZJ4p_");
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'Batch_Steward_Withdraw_Customers_Sending_Request_Copy' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2025-06-26T10:01:25.065369500Z");
        ...
        try {
            ...
            java.io.InputStream inContext = Batch_Steward_Withdraw_Customers_Sending_Request_Copy.class.getClassLoader().getResourceAsStream("dpdp/batch_steward_withdraw_customers_sending_request_copy_0_4/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     328113 characters generated by Talend Real-time Big Data Platform 
 *     on the 26 June 2025 at 3:31:25 pm IST
 ************************************************************************************************/