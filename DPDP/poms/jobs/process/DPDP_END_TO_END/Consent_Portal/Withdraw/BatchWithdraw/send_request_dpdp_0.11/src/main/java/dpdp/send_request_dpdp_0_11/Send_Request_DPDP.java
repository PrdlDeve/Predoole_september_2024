...
package dpdp.send_request_dpdp_0_11;
...
/**
 * Job: Send_Request_DPDP Purpose: <br>
 * Description:  <br>
 * @author Patil, Chirag
 * @version 8.0.1.20250521_1150-patch
 * @status 
 */
public class Send_Request_DPDP implements TalendJob {
	static {System.setProperty("TalendJob.log", "Send_Request_DPDP.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Send_Request_DPDP.class);
...
public String getStewardship_UserName(){
	...
	private final String jobName = "Send_Request_DPDP";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_9Wtp0FZdEfClzKBwPKe_HA", "0.11");
...
private class TalendException extends Exception {
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TalendException)) {
			Send_Request_DPDP.this.exception = e;
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Send_Request_DPDP.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class RestServiceProviderImpl4TalendJob {
	...
	private final Send_Request_DPDP job;


	public RestServiceProviderImpl4TalendJob() {
		this.job = new Send_Request_DPDP();
	}

	public RestServiceProviderImpl4TalendJob(Send_Request_DPDP job) {
		this.job = job;
	}

	private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, Send_Request_DPDP job) {
	...
	private jakarta.ws.rs.core.Response processRequest(java.util.Map<String, Object> request) {
		...
		try {
            ...
            String taskExecutionId = Send_Request_DPDP.taskExecutionId;
            String jobExecutionId = Send_Request_DPDP.jobExecutionId;
...
class Thread4RestServiceProviderEndpoint extends Thread {
	...
	public Thread4RestServiceProviderEndpoint(Send_Request_DPDP job, String endpointUrl) {
		this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = Send_Request_DPDP.class.getClassLoader()
					.getResourceAsStream("dpdp/send_request_dpdp_0_11/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
				inContext = Send_Request_DPDP.class.getClassLoader()
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_DPDP_Send_Request_DPDP = new byte[0];
    static byte[] commonByteArray_DPDP_Send_Request_DPDP = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DPDP_Send_Request_DPDP.length) {
				if(length < 1024 && commonByteArray_DPDP_Send_Request_DPDP.length == 0) {
   					commonByteArray_DPDP_Send_Request_DPDP = new byte[1024];
				} else {
   					commonByteArray_DPDP_Send_Request_DPDP = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DPDP_Send_Request_DPDP, 0, length);
			strReturn = new String(commonByteArray_DPDP_Send_Request_DPDP, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_DPDP_Send_Request_DPDP, 0, length);
			strReturn = new String(commonByteArray_DPDP_Send_Request_DPDP, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DPDP_Send_Request_DPDP) {
...
public void tRESTRequest_1_LoopProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		mdc("tRESTRequest_1_Loop", "tsqVoL_");
...
org.talend.components.datastewardship.tdatastewardshiptaskinput.TDataStewardshipTaskInputProperties props_tDataStewardshipTaskInput_1 =
        (org.talend.components.datastewardship.tdatastewardshiptaskinput.TDataStewardshipTaskInputProperties) def_tDataStewardshipTaskInput_1.createRuntimeProperties();
 		                    ...
 		                    "pranita.p@predoole.com");
 		                    
 		                        props_tDataStewardshipTaskInput_1.connection.setValue("password",
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:aM59XTVyMOq9qM/INJwaqjqA7+srsjpNaG/nUtU9ELEplzRVdEeMyPgzOVZjIkNUQPrH4AyMasfguUVBcqk193I+sSmzdwNGIxNS5DDxI3nl8Val30CA+7jxe3g="));
 ...
 */
    ...
    public static void main(String[] args){
        final Send_Request_DPDP Send_Request_DPDPClass = new Send_Request_DPDP();

        int exitCode = Send_Request_DPDPClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Send_Request_DPDP' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'Send_Request_DPDP' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_9Wtp0FZdEfClzKBwPKe_HA");
                org.slf4j.MDC.put("_compiledAtTimestamp","2025-07-01T09:31:08.763424300Z");
        ...
        try {
            ...
            java.io.InputStream inContext = Send_Request_DPDP.class.getClassLoader().getResourceAsStream("dpdp/send_request_dpdp_0_11/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Send_Request_DPDP.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'Send_Request_DPDP' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Send_Request_DPDP");
        }
		if(enableLogStash) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'Send_Request_DPDP' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     321244 characters generated by Talend Real-time Big Data Platform 
 *     on the 1 July 2025 at 3:01:08 pm IST
 ************************************************************************************************/