...
package dpdp.batch_stewardship_withdraw_customers_accepting_delete_request_0_3;
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_IIjBwFApEfC4ZuKDeZl3GA", "0.3");
...
public String getRestEndpoint() {
	return "http://192.168.1.163:8060/GDPR";
}
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request.class.getClassLoader()
					.getResourceAsStream("dpdp/batch_stewardship_withdraw_customers_accepting_delete_request_0_3/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
 ...
 */
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBRow_1{
                    ...
                    log4jParamters_tDBRow_1.append("Parameters:");
                        ...
                        log4jParamters_tDBRow_1.append(" | ");
                            log4jParamters_tDBRow_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:05vcUNGqNcUkFRo944mQ2oYw0cJisZ48uQfN505YQcHRiR3qQ0yynvQ=").substring(0, 4) + "...");     
                        log4jParamters_tDBRow_1.append(" | ");
	...
	final String decryptedPassword_tDBRow_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:P1qO3qttp/wapBeLa/eTnxmAggjTFUqqXaTBVMmtNH6sPvMrAD7Y5BQ=");
...
public void tRESTRequest_2_LoopProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		mdc("tRESTRequest_2_Loop", "DM1ULF_");
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2025-06-26T09:44:20.315724800Z");
        ...
        try {
            ...
            java.io.InputStream inContext = Batch_Stewardship_Withdraw_Customers_Accepting_Delete_Request.class.getClassLoader().getResourceAsStream("dpdp/batch_stewardship_withdraw_customers_accepting_delete_request_0_3/contexts/" + contextStr + ".properties");
            if (inContext == null) {
 ...
 *     on the 26 June 2025 at 3:14:20 pm IST
 ************************************************************************************************/