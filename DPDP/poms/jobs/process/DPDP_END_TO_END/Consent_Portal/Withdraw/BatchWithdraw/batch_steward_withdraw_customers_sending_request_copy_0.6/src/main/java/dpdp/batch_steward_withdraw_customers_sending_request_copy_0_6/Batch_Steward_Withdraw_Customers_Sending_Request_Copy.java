...
package dpdp.batch_steward_withdraw_customers_sending_request_copy_0_6;
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_ICn_8FApEfC4ZuKDeZl3GA", "0.6");
...
public String getRestEndpoint() {
	return "http://192.168.1.163:8040/steward";
}
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = Batch_Steward_Withdraw_Customers_Sending_Request_Copy.class.getClassLoader()
					.getResourceAsStream("dpdp/batch_steward_withdraw_customers_sending_request_copy_0_6/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
...
try {
	...
	String url = null;
		...
		url = "http://192.168.1.163:8040/GDPR/customer/";
		// {baseUri}tRESTClient
...
public void tRESTRequest_1_LoopProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		mdc("tRESTRequest_1_Loop", "revyNe_");
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'Batch_Steward_Withdraw_Customers_Sending_Request_Copy' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2025-06-26T11:32:21.838523500Z");
        ...
        try {
            ...
            java.io.InputStream inContext = Batch_Steward_Withdraw_Customers_Sending_Request_Copy.class.getClassLoader().getResourceAsStream("dpdp/batch_steward_withdraw_customers_sending_request_copy_0_6/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     328095 characters generated by Talend Real-time Big Data Platform 
 *     on the 26 June 2025 at 5:02:21 pm IST
 ************************************************************************************************/