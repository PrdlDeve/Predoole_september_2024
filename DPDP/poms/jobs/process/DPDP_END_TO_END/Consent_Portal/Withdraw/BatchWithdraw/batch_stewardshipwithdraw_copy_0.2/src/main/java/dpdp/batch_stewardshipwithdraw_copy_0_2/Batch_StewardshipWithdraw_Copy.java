...
package dpdp.batch_stewardshipwithdraw_copy_0_2;
...
public class Batch_StewardshipWithdraw_Copy implements TalendJob {
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = Batch_StewardshipWithdraw_Copy.class.getClassLoader().getResourceAsStream(
					"dpdp/batch_stewardshipwithdraw_copy_0_2/contexts/" + currentContext + ".properties");
			if (inContext == null) {
	...
	public void tRESTRequest_1_LoopProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		mdc("tRESTRequest_1_Loop", "o02Whi_");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					props_tDataStewardshipTaskOutput_1.setValue("arbitrationChoice", "1");
...
// finally of generic
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2025-07-02T06:58:47.561658500Z");
		...
		try {
			...
			java.io.InputStream inContext = Batch_StewardshipWithdraw_Copy.class.getClassLoader().getResourceAsStream(
					"dpdp/batch_stewardshipwithdraw_copy_0_2/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Batch_StewardshipWithdraw_Copy.class.getClassLoader()
...
/************************************************************************************************
 * 134761 characters generated by Talend Real-time Big Data Platform on the 2
 * July 2025 at 12:28:47 pm IST
 ************************************************************************************************/