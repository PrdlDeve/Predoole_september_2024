...
package dpdp.batch_steward_withdraw_customers_sending_request_copy_0_12;
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_ICn_8FApEfC4ZuKDeZl3GA", "0.12");
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = Batch_Steward_Withdraw_Customers_Sending_Request_Copy.class.getClassLoader()
					.getResourceAsStream("dpdp/batch_steward_withdraw_customers_sending_request_copy_0_12/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
...
try {
	...
	String url = null;
		...
		url = "http://192.168.1.163:8040/services/GDPR/customer/";
		// {baseUri}tRESTClient
...
public void tRESTRequest_1_LoopProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		mdc("tRESTRequest_1_Loop", "DTjac7_");
...
org.talend.components.datastewardship.tdatastewardshiptaskinput.TDataStewardshipTaskInputProperties props_tDataStewardshipTaskInput_1 =
        (org.talend.components.datastewardship.tdatastewardshiptaskinput.TDataStewardshipTaskInputProperties) def_tDataStewardshipTaskInput_1.createRuntimeProperties();
 		                    ...
 		                    "pranita.p@predoole.com");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:/X2Y5MiFpUWPxuAoDOPRg8Q5VNtRK1KGry4oKOx0fAYc2LG2KzNJ4sEI57vuEbI42j60A+cSQ/WcrkmHVF08OaCeMqDLq4xA2zzzBnRGu/NBfbzwRT/2f9LnXmE="));
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'Batch_Steward_Withdraw_Customers_Sending_Request_Copy' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2025-07-02T05:25:56.862245Z");
        ...
        try {
            ...
            java.io.InputStream inContext = Batch_Steward_Withdraw_Customers_Sending_Request_Copy.class.getClassLoader().getResourceAsStream("dpdp/batch_steward_withdraw_customers_sending_request_copy_0_12/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     328296 characters generated by Talend Real-time Big Data Platform 
 *     on the 2 July 2025 at 10:55:56 am IST
 ************************************************************************************************/