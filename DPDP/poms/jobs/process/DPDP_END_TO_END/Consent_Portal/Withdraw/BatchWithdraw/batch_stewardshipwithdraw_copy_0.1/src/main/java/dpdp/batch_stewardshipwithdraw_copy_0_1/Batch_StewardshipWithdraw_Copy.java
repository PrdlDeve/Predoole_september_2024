...
package dpdp.batch_stewardshipwithdraw_copy_0_1;
...
public class Batch_StewardshipWithdraw_Copy implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Batch_StewardshipWithdraw_Copy.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(Batch_StewardshipWithdraw_Copy.class);
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Batch_StewardshipWithdraw_Copy.this,
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap,
				Batch_StewardshipWithdraw_Copy job) {
			...
			if (requiredParameterWithNullValueList.size() > 0) {
				return handleWrongRequest(messageContext, 400,
						"400 Bad Request \n" + requiredParameterWithNullValueList.toString()
								+ " in tRESTRequest_1:deleteCustomer "
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = Batch_StewardshipWithdraw_Copy.class.getClassLoader().getResourceAsStream(
					"dpdp/batch_stewardshipwithdraw_copy_0_1/contexts/" + currentContext + ".properties");
			if (inContext == null) {
	...
	public void tRESTRequest_1_LoopProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		mdc("tRESTRequest_1_Loop", "ie05xr_");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				runStat.updateStatAndLog(execStat, enableLogStash, iterateId, 0, 0, "deleteCustomer", "withdraw");
				...
				try {
					...
					runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, 0, 0, "withdraw");
					...
					props_tDataStewardshipTaskOutput_1.setValue("campaignName", "c9d5dbce7d87cede9e0224bb3a48ca1d7");

					props_tDataStewardshipTaskOutput_1.setValue("campaignLabel", "Withdraw");
					...
					props_tDataStewardshipTaskOutput_1.setValue("taskAssignee", "Custom");

					props_tDataStewardshipTaskOutput_1.setValue("arbitrationChoice", "NO_CHOICE");
					...
					props_tDataStewardshipTaskOutput_1.connection.setValue("url", context.Stewardship_URL);

					props_tDataStewardshipTaskOutput_1.connection.setValue("username", context.Stewardship_UserName);

					props_tDataStewardshipTaskOutput_1.connection.setValue("password", context.Stewardship_Password);
					...
					java.net.URL mappings_url_tDataStewardshipTaskOutput_1 = this.getClass()
							.getResource("/xmlMappings");
					globalMap.put("tDataStewardshipTaskOutput_1_MAPPINGS_URL",
							mappings_url_tDataStewardshipTaskOutput_1);
					...
					if (sourceOrSink_tDataStewardshipTaskOutput_1 instanceof org.talend.components.api.component.runtime.Sink) {
						...
						if (doesNodeBelongToRequest_tDataStewardshipTaskOutput_1) {
							writeOperation_tDataStewardshipTaskOutput_1
									.initialize(container_tDataStewardshipTaskOutput_1);
						}
...
// Start of branch "deleteCustomer"
					if (deleteCustomer != null) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "deleteCustomer", "tRESTRequest_1_In", "CustomerRequest_In", "tRESTRequestIn",
								"tMap_1", "tMap_1", "tMap"
...
// # Output table : 'withdraw'
							...
							log.debug("tMap_1 - Outputting the record " + count_withdraw_tMap_1
									+ " of the output table 'withdraw'.");
...
// Start of branch "withdraw"
						if (withdraw != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "withdraw", "tMap_1", "tMap_1", "tMap", "tDataStewardshipTaskOutput_1",
							...
							if (incomingEnforcer_tDataStewardshipTaskOutput_1 != null
								...
								incomingEnforcer_tDataStewardshipTaskOutput_1.addIncomingNodeField("Customer_Id",
										((Object) withdraw.Customer_Id).getClass().getCanonicalName());
								shouldCreateRuntimeSchemaForIncomingNode = true;
							}
							if (incomingEnforcer_tDataStewardshipTaskOutput_1 != null
									&& incomingEnforcer_tDataStewardshipTaskOutput_1.getDesignSchema()
											.getField("Reason") == null) {
								incomingEnforcer_tDataStewardshipTaskOutput_1.addIncomingNodeField("Reason",
										((Object) withdraw.Reason).getClass().getCanonicalName());
								shouldCreateRuntimeSchemaForIncomingNode = true;
							}
							if (incomingEnforcer_tDataStewardshipTaskOutput_1 != null
									&& incomingEnforcer_tDataStewardshipTaskOutput_1.getDesignSchema()
											.getField("TDS_DUE_DATE") == null) {
								incomingEnforcer_tDataStewardshipTaskOutput_1.addIncomingNodeField("TDS_DUE_DATE",
										((Object) withdraw.TDS_DUE_DATE).getClass().getCanonicalName());
								shouldCreateRuntimeSchemaForIncomingNode = true;
							}
							if (incomingEnforcer_tDataStewardshipTaskOutput_1 != null
									&& incomingEnforcer_tDataStewardshipTaskOutput_1.getDesignSchema()
											.getField("TDS_EXTERNAL_ID") == null) {
								incomingEnforcer_tDataStewardshipTaskOutput_1.addIncomingNodeField("TDS_EXTERNAL_ID",
										((Object) withdraw.TDS_EXTERNAL_ID).getClass().getCanonicalName());
								shouldCreateRuntimeSchemaForIncomingNode = true;
							}
							...
							if (incomingEnforcer_tDataStewardshipTaskOutput_1 != null
									&& incomingEnforcer_tDataStewardshipTaskOutput_1.getRuntimeSchema()
											.getField("TDS_DUE_DATE") != null) {
								incomingEnforcer_tDataStewardshipTaskOutput_1.put("TDS_DUE_DATE",
										withdraw.TDS_DUE_DATE);
							}
							// skip the put action if the input column doesn't appear in component runtime
							// schema
							if (incomingEnforcer_tDataStewardshipTaskOutput_1 != null
									&& incomingEnforcer_tDataStewardshipTaskOutput_1.getRuntimeSchema()
											.getField("TDS_EXTERNAL_ID") != null) {
								incomingEnforcer_tDataStewardshipTaskOutput_1.put("TDS_EXTERNAL_ID",
										withdraw.TDS_EXTERNAL_ID);
							}
							props_tDataStewardshipTaskOutput_1.setValue("customAssignee", "");
...
// ###############################      
						...
						if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "deleteCustomer",
								2, 0, "tRESTRequest_1_In", "CustomerRequest_In", "tRESTRequestIn", "tMap_1", "tMap_1",
								"tMap", "output")) {
							talendJobLogProcess(globalMap);
						}
...
// end of generic
					...
					if (resultMap_tDataStewardshipTaskOutput_1 != null) {
						for (java.util.Map.Entry<String, Object> entry_tDataStewardshipTaskOutput_1 : resultMap_tDataStewardshipTaskOutput_1
							...
							default:
								...
								container_tDataStewardshipTaskOutput_1.setComponentData("tDataStewardshipTaskOutput_1",
										studio_key_tDataStewardshipTaskOutput_1.toString()
					...
					if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "withdraw", 2, 0,
							"tMap_1", "tMap_1", "tMap", "tDataStewardshipTaskOutput_1", "tDataStewardshipTaskOutput_1",
				...
				runStat.updateStatAndLog(execStat, enableLogStash, iterateId, 2, 0, "deleteCustomer", "withdraw");
...
// finally of generic
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2025-06-24T11:25:48.690570900Z");
		...
		try {
			...
			java.io.InputStream inContext = Batch_StewardshipWithdraw_Copy.class.getClassLoader().getResourceAsStream(
					"dpdp/batch_stewardshipwithdraw_copy_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Batch_StewardshipWithdraw_Copy.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Batch_StewardshipWithdraw_Copy");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'Batch_StewardshipWithdraw_Copy' - Finished - status: " + status + " returnCode: "
				+ returnCode);
...
/************************************************************************************************
 * 134769 characters generated by Talend Real-time Big Data Platform on the 24
 * June 2025 at 4:55:48 pm IST
 ************************************************************************************************/